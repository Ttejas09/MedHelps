import { Calendar, Shield, Siren, Pill, CalendarPlus, Stethoscope } from 'lucide-react';
...
const features = [
  ...
  },
  {
    ...
    description: 'Click to schedule your appointment with a specialist.',
    gradient: 'from-indigo-500 to-indigo-600',
    externalLink: 'https://aesthetic-meringue-bdc5bf.netlify.app', // Your live URL
  },
  {
    icon: Stethoscope, // New icon
    title: 'Connect Doctor',
    description: 'Chat or start a video call with a certified doctor.',
    gradient: 'from-green-500 to-green-600', // New color
    externalLink: 'https://telehealth09.netlify.app/patient.html', // Internal link (you will need to create this page)
  },
  {
    icon: Pill,
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <div
                ...
                onClick={() => {
                  if (feature.link) {
                    // This part is for your INTERNAL links (which are working)
                    navigate(feature.link);
                  } else if (feature.externalLink) {
                    // This part is for your EXTERNAL links (this is what you're missing)
