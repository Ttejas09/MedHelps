      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-3xl font-bold text-charcoal">Hospitals</p>
              <p className="text-gray-600 font-medium">Mapped</p>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <div>
              <p className="text-3xl font-bold text-charcoal">Peer to Peer</p>
